...
namespace StudentsRepository.Data.Optimizations
{
    public partial class ApplicationDbContextModel
    {
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var applicationUser = FindEntityType("StudentsRepository.Data.ApplicationUser")!;
            ...
            var studentsRepositoryDataApplicationUserTableBase = new TableBase("StudentsRepository.Data.ApplicationUser", null, relationalModel);
            var accessFailedCountColumnBase = new ColumnBase<ColumnMappingBase>("AccessFailedCount", "int", studentsRepositoryDataApplicationUserTableBase);
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("AccessFailedCount", accessFailedCountColumnBase);
            var concurrencyStampColumnBase0 = new ColumnBase<ColumnMappingBase>("ConcurrencyStamp", "nvarchar(max)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("ConcurrencyStamp", concurrencyStampColumnBase0);
            var emailColumnBase = new ColumnBase<ColumnMappingBase>("Email", "nvarchar(256)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("Email", emailColumnBase);
            var emailConfirmedColumnBase = new ColumnBase<ColumnMappingBase>("EmailConfirmed", "bit", studentsRepositoryDataApplicationUserTableBase);
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("EmailConfirmed", emailConfirmedColumnBase);
            var idColumnBase2 = new ColumnBase<ColumnMappingBase>("Id", "nvarchar(450)", studentsRepositoryDataApplicationUserTableBase);
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("Id", idColumnBase2);
            var lockoutEnabledColumnBase = new ColumnBase<ColumnMappingBase>("LockoutEnabled", "bit", studentsRepositoryDataApplicationUserTableBase);
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("LockoutEnabled", lockoutEnabledColumnBase);
            var lockoutEndColumnBase = new ColumnBase<ColumnMappingBase>("LockoutEnd", "datetimeoffset", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("LockoutEnd", lockoutEndColumnBase);
            var normalizedEmailColumnBase = new ColumnBase<ColumnMappingBase>("NormalizedEmail", "nvarchar(256)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("NormalizedEmail", normalizedEmailColumnBase);
            var normalizedUserNameColumnBase = new ColumnBase<ColumnMappingBase>("NormalizedUserName", "nvarchar(256)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("NormalizedUserName", normalizedUserNameColumnBase);
            var passwordHashColumnBase = new ColumnBase<ColumnMappingBase>("PasswordHash", "nvarchar(max)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("PasswordHash", passwordHashColumnBase);
            var phoneNumberColumnBase = new ColumnBase<ColumnMappingBase>("PhoneNumber", "nvarchar(max)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("PhoneNumber", phoneNumberColumnBase);
            var phoneNumberConfirmedColumnBase = new ColumnBase<ColumnMappingBase>("PhoneNumberConfirmed", "bit", studentsRepositoryDataApplicationUserTableBase);
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("PhoneNumberConfirmed", phoneNumberConfirmedColumnBase);
            var securityStampColumnBase = new ColumnBase<ColumnMappingBase>("SecurityStamp", "nvarchar(max)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("SecurityStamp", securityStampColumnBase);
            var twoFactorEnabledColumnBase = new ColumnBase<ColumnMappingBase>("TwoFactorEnabled", "bit", studentsRepositoryDataApplicationUserTableBase);
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("TwoFactorEnabled", twoFactorEnabledColumnBase);
            var userNameColumnBase = new ColumnBase<ColumnMappingBase>("UserName", "nvarchar(256)", studentsRepositoryDataApplicationUserTableBase)
            {
                IsNullable = true
            };
            studentsRepositoryDataApplicationUserTableBase.Columns.Add("UserName", userNameColumnBase);
            relationalModel.DefaultTables.Add("StudentsRepository.Data.ApplicationUser", studentsRepositoryDataApplicationUserTableBase);
            var studentsRepositoryDataApplicationUserMappingBase = new TableMappingBase<ColumnMappingBase>(applicationUser, studentsRepositoryDataApplicationUserTableBase, true);
            studentsRepositoryDataApplicationUserTableBase.AddTypeMapping(studentsRepositoryDataApplicationUserMappingBase, false);
            defaultTableMappings5.Add(studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase2, applicationUser.FindProperty("Id")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)accessFailedCountColumnBase, applicationUser.FindProperty("AccessFailedCount")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)concurrencyStampColumnBase0, applicationUser.FindProperty("ConcurrencyStamp")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)emailColumnBase, applicationUser.FindProperty("Email")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)emailConfirmedColumnBase, applicationUser.FindProperty("EmailConfirmed")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lockoutEnabledColumnBase, applicationUser.FindProperty("LockoutEnabled")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)lockoutEndColumnBase, applicationUser.FindProperty("LockoutEnd")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalizedEmailColumnBase, applicationUser.FindProperty("NormalizedEmail")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)normalizedUserNameColumnBase, applicationUser.FindProperty("NormalizedUserName")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)passwordHashColumnBase, applicationUser.FindProperty("PasswordHash")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)phoneNumberColumnBase, applicationUser.FindProperty("PhoneNumber")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)phoneNumberConfirmedColumnBase, applicationUser.FindProperty("PhoneNumberConfirmed")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)securityStampColumnBase, applicationUser.FindProperty("SecurityStamp")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)twoFactorEnabledColumnBase, applicationUser.FindProperty("TwoFactorEnabled")!, studentsRepositoryDataApplicationUserMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)userNameColumnBase, applicationUser.FindProperty("UserName")!, studentsRepositoryDataApplicationUserMappingBase);
            ...
            var pK_AspNetUsersUc = RelationalModel.GetKey(this,
                "StudentsRepository.Data.ApplicationUser",
                new[] { "Id" });
            ...
            var student = FindEntityType("StudentsRepository.Models.Students.Student")!;

            var defaultTableMappings6 = new List<TableMappingBase<ColumnMappingBase>>();
            student.SetRuntimeAnnotation("Relational:DefaultMappings", defaultTableMappings6);
            var studentsRepositoryModelsStudentsStudentTableBase = new TableBase("StudentsRepository.Models.Students.Student", null, relationalModel);
            var familyNameColumnBase = new ColumnBase<ColumnMappingBase>("FamilyName", "nvarchar(450)", studentsRepositoryModelsStudentsStudentTableBase);
            studentsRepositoryModelsStudentsStudentTableBase.Columns.Add("FamilyName", familyNameColumnBase);
            var givenNameColumnBase = new ColumnBase<ColumnMappingBase>("GivenName", "nvarchar(450)", studentsRepositoryModelsStudentsStudentTableBase);
            studentsRepositoryModelsStudentsStudentTableBase.Columns.Add("GivenName", givenNameColumnBase);
            var idColumnBase3 = new ColumnBase<ColumnMappingBase>("Id", "int", studentsRepositoryModelsStudentsStudentTableBase);
            studentsRepositoryModelsStudentsStudentTableBase.Columns.Add("Id", idColumnBase3);
            relationalModel.DefaultTables.Add("StudentsRepository.Models.Students.Student", studentsRepositoryModelsStudentsStudentTableBase);
            var studentsRepositoryModelsStudentsStudentMappingBase = new TableMappingBase<ColumnMappingBase>(student, studentsRepositoryModelsStudentsStudentTableBase, true);
            studentsRepositoryModelsStudentsStudentTableBase.AddTypeMapping(studentsRepositoryModelsStudentsStudentMappingBase, false);
            defaultTableMappings6.Add(studentsRepositoryModelsStudentsStudentMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)idColumnBase3, student.FindProperty("Id")!, studentsRepositoryModelsStudentsStudentMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)familyNameColumnBase, student.FindProperty("FamilyName")!, studentsRepositoryModelsStudentsStudentMappingBase);
            RelationalModel.CreateColumnMapping((ColumnBase<ColumnMappingBase>)givenNameColumnBase, student.FindProperty("GivenName")!, studentsRepositoryModelsStudentsStudentMappingBase);

            var tableMappings6 = new List<TableMapping>();
            student.SetRuntimeAnnotation("Relational:TableMappings", tableMappings6);
            var studentsTable = new Table("Students", null, relationalModel);
            var idColumn3 = new Column("Id", "int", studentsTable);
            studentsTable.Columns.Add("Id", idColumn3);
            var familyNameColumn = new Column("FamilyName", "nvarchar(450)", studentsTable);
            studentsTable.Columns.Add("FamilyName", familyNameColumn);
            var givenNameColumn = new Column("GivenName", "nvarchar(450)", studentsTable);
            studentsTable.Columns.Add("GivenName", givenNameColumn);
            var pK_Students = new UniqueConstraint("PK_Students", studentsTable, new[] { idColumn3 });
            studentsTable.PrimaryKey = pK_Students;
            var pK_StudentsUc = RelationalModel.GetKey(this,
                "StudentsRepository.Models.Students.Student",
                new[] { "Id" });
            pK_Students.MappedKeys.Add(pK_StudentsUc);
            RelationalModel.GetOrCreateUniqueConstraints(pK_StudentsUc).Add(pK_Students);
            studentsTable.UniqueConstraints.Add("PK_Students", pK_Students);
            relationalModel.Tables.Add(("Students", null), studentsTable);
            var studentsTableMapping = new TableMapping(student, studentsTable, true);
            studentsTable.AddTypeMapping(studentsTableMapping, false);
            tableMappings6.Add(studentsTableMapping);
            RelationalModel.CreateColumnMapping(idColumn3, student.FindProperty("Id")!, studentsTableMapping);
            RelationalModel.CreateColumnMapping(familyNameColumn, student.FindProperty("FamilyName")!, studentsTableMapping);
            RelationalModel.CreateColumnMapping(givenNameColumn, student.FindProperty("GivenName")!, studentsTableMapping);
